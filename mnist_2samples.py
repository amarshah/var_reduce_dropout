...
dropout_2_in = Lambda(lambda x: x * maskx2, output_shape=(n_in,))
dropout_2_layer1 = Lambda(lambda x: x * mask5, output_shape = (n_layer,))
dropout_2_layer2 = Lambda(lambda x: x * mask6, output_shape = (n_layer,))
dropout_2_layer3 = Lambda(lambda x: x * mask7, output_shape = (n_layer,))
dropout_2_layer4 = Lambda(lambda x: x * mask8, output_shape = (n_layer,))
...
out2 = layer1(dropout_2_in(x))
out2 = layer2(dropout_2_layer1(out2))
out2 = layer3(dropout_2_layer2(out2))
out2 = layer4(dropout_2_layer3(out2))
out2 = softmax_layer(dropout_2_layer4(out2))
